...
//die;
  ...
  // print_r($username);die;
			 ...
			 $b=select_users_alll($conn,$id);
			
			//print_r($b);die;
			$pndcnt=0;
			$status=0;
			foreach($b as $m =>$value){
			print_r($value);
			if($value['approve']=='pending')
			{
				$pndcnt++;
			}else{
				$status++;
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Leave Status </a>
                ...
                <div class="badge badge-warning"><?php  ?></div></a></li>
				                         
           <div class='ml-3'>   
      <span class="badge badge-warning p-2"><sup ><a href="pending.php?id=Pending Leaves<?php echo $pndcnt ?>">Pending Leaves<?php echo $pndcnt ?></a></sup></span><br>
			 <span class="badge badge-success p-2"><sup><a href="approved.php?id=approve Leaves<?php echo $status ?>">approved leaves<?php echo $status ?></a></sup></span>
			</div>
